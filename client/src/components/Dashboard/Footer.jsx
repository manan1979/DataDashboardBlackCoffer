    ...
    <Box bg={footerBgColor} py={4}>
      ...
      >
        <Text fontSize="sm" color="gray.500">
          &copy; 2023 Manan Saini. All rights reserved.
        </Text>
        <Flex alignItems="center">
          ...
          <Box mx={2}>
            <Icon as={RiFacebookBoxFill} boxSize={0} color={iconColor} />
          </Box>
          <Box mx={2}>
            <Icon as={RiTwitterFill} boxSize={0} color={iconColor} />
          </Box>
          <Box mx={2}>
            <Icon as={RiInstagramFill} boxSize={0} color={iconColor} />
          </Box>
        </Flex>
      </Flex>
    </Box>
